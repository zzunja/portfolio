...
export default function Home() {
  ...
  return (
    <div className="w-95/100 text-dark dark:text-white mx-auto font-mono sm:w-[856px] text-lg mb-3 sm:mb-[15vh]">
      ...
      <p className="mt-4 mb-6">Hi, I'm Mason McCombs, an undergrad Cyber Security student currently attending UTSA. I have a strong interest in Malware Development and Reverse Engineering. I also enjoy making websites. Here are a list of projects that I have done.</p>
